...
const formatMapFeature = (feature) => {
    ...
    address += `, ${feature.context[0].text || ""}, ${feature.context[2].text || ""}, ${
        feature.context[3].text || ""
    }`;
...
if (queryParams.get("lng") !== undefined && queryParams.get("lat") !== undefined) {
    const api = `https://revgeocode.search.hereapi.com/v1/revgeocode?at=${queryParams.get(
        "lat"
    )},${queryParams.get("lng")}&apiKey=${reverseGeoCodingApiKey}&lang=vi&limit=5`;
